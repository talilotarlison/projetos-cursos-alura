...
let numSorte = Math.floor(Math.random() * (10 - 0 + 1) + 0);

// Para isso, utilize o código:
// Math.floor(Math.random() * (máximo - mínimo + 1) + mínimo)

let numero = prompt("Escolha um numero de 0 a 10!!");

if(numSorte === parseInt(numero)){
     alert(`Você acertou!! o numero da sorte era ${numSorte}.`);
}else{
       alert(`Você ERROU!! o numero da sorte era ${numSorte}.`);
}